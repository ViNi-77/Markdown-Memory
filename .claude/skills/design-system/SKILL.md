...
## Markdown Memory Adaptation

Use this Application skill as a product UI baseline for Markdown Memory, not as a wholesale theme replacement.

- Preserve the existing four-pane workspace model: folders, file list, Markdown reading/editing surface, and details/actions.
- Keep the current shadcn/base-nova semantic tokens as the source of truth. Do not replace the app palette with raw purple values.
- Treat "top-bar only navigation" as non-binding for this app; stable panes and mobile pane navigation are more important.
- Prefer calm density, explicit interaction states, and readable Markdown over decorative glass panels or card-heavy layouts.
- When improving UI, follow `docs/UI_DESIGN_IMPROVEMENTS.md` for the current backlog and quality gates.
