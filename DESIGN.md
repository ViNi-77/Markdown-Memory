...
Markdown Memory adopts this as an application-workspace direction, not as a full visual reset. The current shadcn/base-nova semantic tokens, Inter typography, four-pane workspace, and mobile pane navigation remain the product source of truth.

Use the skill to improve:

- hierarchy and scanning in the file list,
- toolbar and save-state clarity in the Markdown surface,
- action grouping in the details and AI pane,
- mobile active/focus/disabled states,
- consistency between login, share, demo, and authenticated workspace screens.

See `docs/UI_DESIGN_IMPROVEMENTS.md` for the current improvement backlog and quality gates.
