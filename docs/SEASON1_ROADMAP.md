...
2026-06-21 時点で Phase 16A に着手しています。リポジトリ側ではTestFlight手順、ユーザー/Codexの役割分担、Release build確認を整えます。Apple Developer Program加入、App Store Connect登録、Xcode Team設定、Archive、TestFlight uploadはユーザー環境で実施します。詳細は [`SEASON1_PHASE16_CHECK.md`](SEASON1_PHASE16_CHECK.md) に記録します。
