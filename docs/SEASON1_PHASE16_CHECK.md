...
- [ ] README / Roadmap / MaintainersでPhase 16を進行中へ更新する
- [ ] Phase 16チェック文書を追加する
- [ ] iOS Shell workflowにRelease build確認を追加する
- [ ] `npm run format:check`
- [ ] `npm run lint`
- [ ] PR CI green
- [ ] PR iOS Shell workflow green
- [ ] Vercel Preview READY
- [ ] main merge後にProduction `/api/health` と `/demo` を確認する
...
2026-06-21 時点で、Phase 16Aに着手しています。Phase 15までに、iOS shell追加、Debug build、Simulator起動確認、Production表示、ログイン後手動スモークは完了済みです。
